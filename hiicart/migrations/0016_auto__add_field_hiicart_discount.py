...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiiCart.discount'
        db.add_column('hiicart_hiicart', 'discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiiCart.discount'
        db.delete_column('hiicart_hiicart', 'discount')
