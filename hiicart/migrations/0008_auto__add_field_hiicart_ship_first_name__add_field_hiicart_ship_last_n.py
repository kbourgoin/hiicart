...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiiCart.ship_first_name'
        db.add_column('hiicart_hiicart', 'ship_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.ship_last_name'
        db.add_column('hiicart_hiicart', 'ship_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.ship_email'
        db.add_column('hiicart_hiicart', 'ship_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'HiiCart.ship_phone'
        db.add_column('hiicart_hiicart', 'ship_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.bill_first_name'
        db.add_column('hiicart_hiicart', 'bill_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.bill_last_name'
        db.add_column('hiicart_hiicart', 'bill_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.bill_email'
        db.add_column('hiicart_hiicart', 'bill_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'HiiCart.bill_phone'
        db.add_column('hiicart_hiicart', 'bill_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiiCart.ship_first_name'
        db.delete_column('hiicart_hiicart', 'ship_first_name')

        # Deleting field 'HiiCart.ship_last_name'
        db.delete_column('hiicart_hiicart', 'ship_last_name')

        # Deleting field 'HiiCart.ship_email'
        db.delete_column('hiicart_hiicart', 'ship_email')

        # Deleting field 'HiiCart.ship_phone'
        db.delete_column('hiicart_hiicart', 'ship_phone')

        # Deleting field 'HiiCart.bill_first_name'
        db.delete_column('hiicart_hiicart', 'bill_first_name')

        # Deleting field 'HiiCart.bill_last_name'
        db.delete_column('hiicart_hiicart', 'bill_last_name')

        # Deleting field 'HiiCart.bill_email'
        db.delete_column('hiicart_hiicart', 'bill_email')

        # Deleting field 'HiiCart.bill_phone'
        db.delete_column('hiicart_hiicart', 'bill_phone')
    ...
    models = {
        ...
        'hiicart.hiicart': {
            ...
            'bill_email': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '75'}),
            'bill_first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'bill_last_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            ...
            'ship_email': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '75'}),
            'ship_first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'ship_last_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'hiicarts'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'hiicart.lineitem': {
