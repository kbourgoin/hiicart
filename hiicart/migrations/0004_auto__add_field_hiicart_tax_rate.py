...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiiCart.tax_rate'
        db.add_column('hiicart_hiicart', 'tax_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=5, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiiCart.tax_rate'
        db.delete_column('hiicart_hiicart', 'tax_rate')
