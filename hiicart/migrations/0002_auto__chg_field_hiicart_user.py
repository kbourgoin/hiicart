...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HiiCart.user'
        db.alter_column('hiicart_hiicart', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'HiiCart.user'
        raise RuntimeError("Cannot reverse this migration. 'HiiCart.user' and its values cannot be restored.")
