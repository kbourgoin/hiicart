...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HiiCart.last_name'
        db.delete_column('hiicart_hiicart', 'last_name')

        # Deleting field 'HiiCart.phone'
        db.delete_column('hiicart_hiicart', 'phone')

        # Deleting field 'HiiCart.first_name'
        db.delete_column('hiicart_hiicart', 'first_name')

        # Deleting field 'HiiCart.email'
        db.delete_column('hiicart_hiicart', 'email')


    def backwards(self, orm):
        
        # Adding field 'HiiCart.last_name'
        db.add_column('hiicart_hiicart', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.phone'
        db.add_column('hiicart_hiicart', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.first_name'
        db.add_column('hiicart_hiicart', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'HiiCart.email'
        db.add_column('hiicart_hiicart', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)
