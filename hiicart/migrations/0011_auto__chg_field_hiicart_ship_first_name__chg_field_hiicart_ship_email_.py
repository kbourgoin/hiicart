...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HiiCart.ship_first_name'
        db.alter_column('hiicart_hiicart', 'ship_first_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'HiiCart.ship_email'
        db.alter_column('hiicart_hiicart', 'ship_email', self.gf('django.db.models.fields.EmailField')(max_length=255))

        # Changing field 'HiiCart.bill_first_name'
        db.alter_column('hiicart_hiicart', 'bill_first_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'HiiCart.bill_last_name'
        db.alter_column('hiicart_hiicart', 'bill_last_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'HiiCart.bill_email'
        db.alter_column('hiicart_hiicart', 'bill_email', self.gf('django.db.models.fields.EmailField')(max_length=255))

        # Changing field 'HiiCart.ship_last_name'
        db.alter_column('hiicart_hiicart', 'ship_last_name', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'HiiCart.ship_first_name'
        db.alter_column('hiicart_hiicart', 'ship_first_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'HiiCart.ship_email'
        db.alter_column('hiicart_hiicart', 'ship_email', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'HiiCart.bill_first_name'
        db.alter_column('hiicart_hiicart', 'bill_first_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'HiiCart.bill_last_name'
        db.alter_column('hiicart_hiicart', 'bill_last_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'HiiCart.bill_email'
        db.alter_column('hiicart_hiicart', 'bill_email', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'HiiCart.ship_last_name'
        db.alter_column('hiicart_hiicart', 'ship_last_name', self.gf('django.db.models.fields.CharField')(max_length=30))
