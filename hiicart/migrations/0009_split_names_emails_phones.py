...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for c in orm.HiiCart.objects.all():
            c.ship_first_name = c.first_name
            c.ship_last_name = c.last_name
            c.ship_email = c.email
            c.ship_phone = c.phone
            c.bill_first_name = c.first_name
            c.bill_last_name = c.last_name
            c.bill_email = c.email
            c.bill_phone = c.phone
            c.save()
    ...
    def backwards(self, orm):
        ...
        for c in orm.HiiCart.objects.all():
            c.first_name = c.ship_first_name
            c.last_name = c.ship_last_name
            c.email = c.ship_email
            c.phone = c.ship_phone
