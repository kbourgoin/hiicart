...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiiCart.fulfilled'
        db.add_column('hiicart_hiicart', 'fulfilled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'HiiCart.custom_id'
        db.add_column('hiicart_hiicart', 'custom_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiiCart.fulfilled'
        db.delete_column('hiicart_hiicart', 'fulfilled')

        # Deleting field 'HiiCart.custom_id'
        db.delete_column('hiicart_hiicart', 'custom_id')
