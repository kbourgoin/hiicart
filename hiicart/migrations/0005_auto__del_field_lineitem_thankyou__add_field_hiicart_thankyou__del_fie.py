...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LineItem.thankyou'
        db.delete_column('hiicart_lineitem', 'thankyou')

        # Adding field 'HiiCart.thankyou'
        db.add_column('hiicart_hiicart', 'thankyou', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'RecurringLineItem.thankyou'
        db.delete_column('hiicart_recurringlineitem', 'thankyou')


    def backwards(self, orm):
        
        # Adding field 'LineItem.thankyou'
        db.add_column('hiicart_lineitem', 'thankyou', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'HiiCart.thankyou'
        db.delete_column('hiicart_hiicart', 'thankyou')

        # Adding field 'RecurringLineItem.thankyou'
        db.add_column('hiicart_recurringlineitem', 'thankyou', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    ...
    models = {
        ...
        'hiicart.hiicart': {
            ...
            'thankyou': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
