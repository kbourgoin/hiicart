...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiiCart.tax_country'
        db.add_column('hiicart_hiicart', 'tax_country', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'HiiCart.tax_region'
        db.add_column('hiicart_hiicart', 'tax_region', self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiiCart.tax_country'
        db.delete_column('hiicart_hiicart', 'tax_country')

        # Deleting field 'HiiCart.tax_region'
        db.delete_column('hiicart_hiicart', 'tax_region')
