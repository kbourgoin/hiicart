...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LineItem.digital_description'
        db.add_column('hiicart_lineitem', 'digital_description', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'RecurringLineItem.digital_description'
        db.add_column('hiicart_recurringlineitem', 'digital_description', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LineItem.digital_description'
        db.delete_column('hiicart_lineitem', 'digital_description')

        # Deleting field 'RecurringLineItem.digital_description'
        db.delete_column('hiicart_recurringlineitem', 'digital_description')
