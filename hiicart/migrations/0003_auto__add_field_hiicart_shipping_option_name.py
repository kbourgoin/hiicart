...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HiiCart.shipping_option_name'
        db.add_column('hiicart_hiicart', 'shipping_option_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HiiCart.shipping_option_name'
        db.delete_column('hiicart_hiicart', 'shipping_option_name')
